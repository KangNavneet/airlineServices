...
<body>
<div class="container" style="box-shadow:15px 15px 15px rgba(0,0,0,0.7);border-radius:5px 25px 25px;border:0.2px solid #ff7600;margin-top:2%">

    <form id="updatepassword" method="post">
        <h1 class="text text-danger">OTP ENTRY</h1>
        <div class="row">
            <div class="col-sm-4">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <input type="hidden" class="form-control"  name="email" id="email" value=<?php echo $_SESSION['userLogin']?>>
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="button" onclick="changePasswordOtp()" value="Change password" class="btn btn-danger" name="changePasswordWithOtpUser" style="box-shadow: 5px 5px rgb(23, 9, 51);
